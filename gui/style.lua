...
local delete_recipe_button_width = 36
...
local ingredients_column_offset = arrow_button_width + delete_recipe_button_width + item_button_width * 2 + default_container_padding * 4
